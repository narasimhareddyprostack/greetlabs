...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Portfolio DVR Pharma</title>
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="page-title-mini">
			<div class="container clearfix">
				<h1>DVR Pharma - Single</h1>
				<span>Everything you need to know about our Company</span>
				<ol class="breadcrumb">
					<li><a href="index.php">Home</a></li>
					<li><a href="portfolio.php">Portfolio</a></li>
					<li class="active">DVR Pharma</li>
				</ol>
			</div>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_two_third portfolio-single-image nobottommargin">
						<a href="http://www.dvrpharma.com/"><img src="images/portfolio/large/dvr.jpg" alt=""></a>
					...
					<div class="col_one_third portfolio-single-content col_last nobottommargin">
						...
						<ul class="portfolio-meta bottommargin">
							...
							<li><span><i class="icon-link"></i>Client:</span> <a href="#">DVR Pharma</a></li>
						</ul>
