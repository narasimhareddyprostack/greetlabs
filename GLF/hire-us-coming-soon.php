			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					<div id="logo" class="divcenter">
						<a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png"><img class="divcenter" src="images/logo.png" alt="GreetLabs Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img class="divcenter" src="images/logo@2x.png" alt="GreetLabs Logo"></a>
				</div><!-- #logo end -->
		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						Copyrights &copy; 2014 All Rights Reserved by GreetLabs Inc.<br>
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> info@greetlabs.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> +91-11-6541-6369 <span class="middot">&middot;</span> <i class="icon-skype2"></i> CanvasOnSkype
					</div>
